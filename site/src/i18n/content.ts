...
export const pageContent: Record<Locale, PageContent> = {
  "zh-CN": {
    ...
    features: {
      ...
      items: [
        ...
        { title: "AI 润色可选", body: "支持 OpenAI 兼容与 Anthropic 原生接口，失败时自动回退本地模板。" },
        { title: "导出不折腾", body: "实时预览、一键复制，按需保存 Markdown、Word 文档或 PDF。" },
  ...
  en: {
    ...
    hero: {
      ...
      facts: [
        { value: "4", label: "report modes" },
        { value: "0", label: "default cloud dependency" },
        { value: "Rust", label: "local Git scanner" },
      ],
    },
    workflow: {
      eyebrow: "Workflow",
    ...
    features: {
      ...
      items: [
        ...
        { title: "Optional AI polishing", body: "Use OpenAI-compatible or Anthropic native APIs, with a local template fallback if polishing fails." },
        { title: "Export without friction", body: "Preview live, copy in one click, or save Markdown, Word documents, and PDF files." },
