...
- [x] Align the author diagnostics with the all-author semantics and flag Git versions below 2.4 in the diagnostics panel so stale `git` no longer silently drops commits.
